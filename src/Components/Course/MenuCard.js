  ...
  return (
    <>
      <div className="menu-card">
        ...
        <div className="difficulty">{"⭑".repeat(recipe[1].difficulty)}</div>
      </div>
      <div className="menu-card">
        <img
        ...
        <div className="difficulty">{"⭑".repeat(recipe[0].difficulty)}</div>
      </div>
      <div className="menu-card">
        <img
        ...
        <div className="difficulty">{"⭑".repeat(recipe[2].difficulty)}</div>
      </div>
      <div className="menu-card">
        <img
        ...
        <div className="difficulty">{"⭑".repeat(recipe[3].difficulty)}</div>
      </div>
      <div className="menu-card">
        <img
        ...
        <div className="difficulty">{"⭑".repeat(recipe[4].difficulty)}</div>
      </div>
    </>
  );
}
